...
knife bootstrap --y $ipaddr --connect-user vagrant --sudo --ssh-identity-file /vagrant/.vagrant/machines/$hostname/virtualbox/private_key --node-name $hostname


git clone https://github.com/Lenya59/tutorials.git

cd ./tutorials/docker-logs-elk
